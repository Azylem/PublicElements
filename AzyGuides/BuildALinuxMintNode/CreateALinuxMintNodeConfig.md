...
These are what I set up in people's houses :), so they can access Dero easily and privately. These machines can also be used for other co-uses, like as a media center.
